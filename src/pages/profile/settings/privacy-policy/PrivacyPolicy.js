            ...
            <>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                    <View style={styles.container}>
                        ...
                        <View style={{}}>
                            <Text style={styles.passwordText}>1. Information Collection </Text>
                            ...
                            <Text style={styles.passwordText}>4. Information Sharing and Disclosure </Text>
                            <Text style={styles.passwordDetailText}>
                            ...
                            <Text style={styles.passwordText}>5. Third Party Analytics Providers, Ad Servers and Similar Third Parties</Text>
                        </View>
