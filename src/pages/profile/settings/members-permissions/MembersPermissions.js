                        ...
                        <View style={styles.card1}>
                            ...
                            <View style={{ padding: 15, borderBottomColor: colors.appGray1, borderBottomWidth: 1 }}>
                                ...
                                <TouchableOpacity style={styles.button}>
                                    <Text style={styles.buttonText}>View or Edit Membership Plan</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={{ padding: 15, borderBottomColor: colors.appGray1, borderBottomWidth: 1 }}>
                                <Text style={styles.passwordSetText}>
                            ...
                            <View style={{ flex: 1, padding: 15, borderBottomColor: colors.appGray1, borderBottomWidth: 1 }}>
                                <Text style={styles.passwordSetText}>
                                    Membership Connects
                                </Text>
                                <Text style={[styles.passwordSetText, { fontSize: 12 }]}>
                                ...
                                <Text style={styles.passwordDetailText}>
                                    Any unused Connects at the end of your billing cycle will roll over to the next month (up to 140).
                                </Text>
