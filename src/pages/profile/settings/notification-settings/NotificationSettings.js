        ...
        return (
            <View style={styles.sectionHeader}>
                ...
                {this.state.activeSections[0] === section.id ? (
                    <Ionicons name="chevron-down-outline" size={16} color={colors.appViolet} />
                ) : (
    ...
    _renderContent = ({ data }) => {
        ...
        return (
            ...
            <View style={styles.content}>
                <RadioGroup data={data} onSelect={this.handleRadioSelect} />
            </View>
        );
    };
                    ...
                    <View style={styles.container}>
                        <View style={styles.card1}>
                            <View style={{ flexDirection: "row", justifyContent: "space-between", padding: 15, borderBottomColor: colors.appGray1, borderBottomWidth: 1 }}>
                                <Text style={[styles.passwordText, { color: colors.skyBlue }]}> Messages</Text>
                        ...
                        <View style={styles.card1}>
                            <View style={{ padding: 15, borderBottomColor: colors.appGray1, borderBottomWidth: 1 }}>
                                <View style={{ flexDirection: "row", justifyContent: "space-between", }}>
                                    <Text style={styles.passwordText}>Two-step verification </Text>
                                    <CustomIcon
                                        name="settings"
                                        color={colors.appGray}
                                        size={20}
                            ...
                            <View style={{ padding: 15, borderBottomColor: colors.appGray1, borderBottomWidth: 1 }}>
                                ...
                                <Text style={styles.passwordDetailText}>
                                    Receive a six digit code by text message to enter along with your password.
                            </Text>
                                <TouchableOpacity style={styles.button}>
                                    <Text style={styles.buttonText}>Enable</Text>
                                </TouchableOpacity>
                            ...
                            <View style={{ flexDirection: "row", padding: 15 }}>
                                ...
                                <View style={{ flex: 1 }}>
                                    ...
                                    <Text style={styles.passwordDetailText}>
                                        Confirm your adentity with a question only you know answer to.
                                </Text>
                                </View>
